...
define("appid","wx1c18dabd2b19e0d9");
define("appsecret","80d26483720ab418a7a0ed681885fa6a");
set_time_limit(0);
...
$preview= array(  
            "touser"=>"owumIjvr6EvXG6fPVxNn9EnN8FrU",
             "mpnews"=>$media_news,
			 "msgtype"=>"mpnews",
			
        ); 

echo $jsondata=json_encode($preview); 	
$access_token=getaccess_token();
$url="https://api.weixin.qq.com/cgi-bin/message/mass/preview?access_token=$access_token";
$result1=https_request($url,$jsondata);
$jsoninfo = json_decode($result1, true);
echo $result1;
