...
require_once "encry/wxBizMsgCrypt.php";
...
http_log("echo:".$echostr);
http_log("time:".$timestamp);
http_log("nonce:".$nonce);
http_log("msg:".$msg_signature );
if($echostr) {
	echo $echostr;
	exit(0);
}
...
mysql_query("set names utf8");
  ...
  $p1 = new yxjzazhi("医学界服务号", "2",$fromUserName ,$toUserName );
